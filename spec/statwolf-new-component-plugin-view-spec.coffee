...
describe "StatwolfNewComponentPluginView", ->
  ...
  beforeEach ->
    ...
    waitsForPromise ->
      atom.packages.activatePackage 'statwolf-atom-configuration'
  ...
  describe 'when a new component is required to be created', ->
    ...
    #   atom.config.get = (cfg) ->
    #     if cfg is 'statwolf-atom-configuration.rootPath'
    #       return '/this/is/my/home'
    #     if cfg is 'statwolf-new-component-plugin.externalTemplateDir'
    #       return '/yet/another/home'
    #
